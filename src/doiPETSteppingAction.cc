...
void doiPETSteppingAction::UserSteppingAction(const G4Step* aStep)
{
	...
	// ***** MODIFIQUE ESTA LÍNEA A ESTO: *****
        if(processName == "annihil"){ // ¡Quite la condición del volumen!
...
// ***** AÑADÍ ESTO AQUÍ *****
        ...
        G4double kineticEnergyTruth = preStepPoint->GetKineticEnergy(); // Energía "Truth"
        G4ThreeVector positionGlobal = preStepPoint->GetPosition();   // Posición GLOBAL
// ***************************
...
// ***** AÑADÍ ESTO AQUÍ *****
                ExtractIntInfo->SetTruthEnergy( kineticEnergyTruth );
                ExtractIntInfo->SetGlobalPosition( positionGlobal );
// ***************************

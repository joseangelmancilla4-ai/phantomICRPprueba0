...
public:
	...
	// Nueva:
	void ReadOut(G4int blkID, G4int cryID, G4double interTime, G4double timeAnnih, G4ThreeVector interPosLocal, G4double edep, G4double truthEnergy, G4ThreeVector globalPos);
...
private:
  ...
  //
	...
	// ***** AÑADÍ ESTO AQUÍ *****
        G4double truthEnergy0, truthEnergy1; // Energía "verdadera"
        G4double xPos0, yPos0, zPos0;        // Posición global del Hit 0
        G4double xPos1, yPos1, zPos1;        // Posición global del Hit 1
	//choice for the user
	...
	// ***** AÑADÍ ESTO AQUÍ *****
	std::vector<G4double> truthEnergy_coin; // Energía antes de entrar al cristal
        std::vector<G4double> xPos_coin;        // Posición X global del hit
        std::vector<G4double> yPos_coin;        // Posición Y global del hit
        std::vector<G4double> zPos_coin;        // Posición Z global del hit

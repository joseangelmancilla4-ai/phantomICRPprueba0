...
public:
	...
	void SetTruthEnergy(G4double energy) { truthEnergy = energy; };
        G4double GetTruthEnergy() { return truthEnergy; };

        void SetGlobalPosition(G4ThreeVector pos) { globalPosition = pos; };
        G4ThreeVector GetGlobalPosition() { return globalPosition; };
// ***************************
...
private:
	...
	G4double truthEnergy;      // Energía cinética antes del paso
        G4ThreeVector globalPosition; // Posición GLOBAL del PreStepPoint
// ***************************

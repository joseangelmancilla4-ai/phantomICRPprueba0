...
int main(int argc,char** argv) 
{
	...
	runManager->SetUserInitialization(new TETActionInitialization(tetData, output, ptrAnalysis));
	...
	/* ---- ---- ---- ---- ---- ---- ---- ---- ---- ----
	   ...
	   ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- */
        ...
        // 🔹 Inicializa el kernel antes de visualizar o ejecutar macros
